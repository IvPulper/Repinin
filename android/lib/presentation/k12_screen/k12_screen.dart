...
class K12Screen extends GetWidget<K12Controller> {
  const K12Screen({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarTitle(
            text: "msg19".tr, margin: EdgeInsets.only(top: 58.v, bottom: 22.v)),
        actions: [
          Container(
              height: 24.adaptSize,
              width: 24.adaptSize,
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    Container(
                        ...
                        child: Column(children: [
                          ...
                          _buildWidget(
                              userText: "lbl28".tr, userZero: "lbl_0_00".tr),
                          SizedBox(height: 8.v),
                          _buildWidget(
                              userText: "lbl29".tr, userZero: "lbl_0_00".tr)
                        ])),
                    ...
                    Obx(() => Column(children: [
                          CustomRadioButton(
                              ...
                              text: "lbl30".tr,
                              value: controller
                                  .k12ModelObj.value.radioList.value[0],
                          ...
                          Padding(
                              ...
                              child: CustomRadioButton(
                                  ...
                                  text: "msg14".tr,
                                  value: controller
                                      .k12ModelObj.value.radioList.value[1],
                                  groupValue: controller.tf.value,
                                  padding: EdgeInsets.symmetric(
                                      horizontal: 19.h, vertical: 10.v),
                                  isRightCheck: true,
                          ...
                          Padding(
                              ...
                              child: CustomRadioButton(
                                  ...
                                  text: "lbl37".tr,
                                  value: controller
                                      .k12ModelObj.value.radioList.value[2],
                                  groupValue: controller.tf.value,
                                  padding: EdgeInsets.symmetric(
                                      horizontal: 19.h, vertical: 10.v),
                                  isRightCheck: true,
